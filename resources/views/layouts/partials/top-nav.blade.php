            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>{{ link_to_route('journal.index', trans('accounting.journal'), 'from_date=2018-10-01&to_date=2018-12-31') }}</li>
                        <li>{{ link_to_route('general-ledger.index', trans('accounting.general-ledger'), 'from_date=2018-10-01&to_date=2018-12-31') }}</li>
                        <li>{{ link_to_route('trial-balance.index', trans('accounting.trial-balance'), 'from_date=2018-10-01&to_date=2018-12-31') }}</li>
