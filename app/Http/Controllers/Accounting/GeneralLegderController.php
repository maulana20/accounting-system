...
class GeneralLegderController extends Controller
{
    public function index(Request $request)
    {
        ...
        $general_ledger = FinancialTrans::selectRaw('gl_analysis.coa_to, gl_analysis.coa_from, coa.code, coa.name, financial_trans.id, financial_trans.period_begin, financial_trans.created_at, gl_analysis.desc')
